...
서울시자원봉사센터 주관 [서울청년기획봉사단](https://www.donghaeng.seoul.kr/vproject/esg.do) 2기 **온쉐어** 팀 팀장으로 활동하면서 시작됐습니다.
팀원들을 이끌며 발달장애인을 위한 AI 요리 챗봇 **온쿡(OnCook)** 을 단독 개발하고, 실제 현장에 투입했습니다.
...
봉사단 활동 성과를 본 **연세대학교 사회복지대학원 HEART Lab**에서 직접 연락이 왔습니다.
"이런 서비스를 만들고 싶다"는 요청에 AI·공학 기술개발자로 유급 합류, Streamlit 기반 웹 프로토타입을 개발해 납품했습니다.

### 3단계 — Hi-Buddy 앱 개발 (현재)

웹 납품 이후, 이 서비스를 제대로 된 모바일 앱으로 만들기로 결심했습니다.
**Flutter로 iOS/Android 앱을 직접 개발**하고, 백엔드 서버 구축, API 전환, 스토어 출시 준비까지 전부 혼자 수행했습니다.
봉사단에서 시작한 아이디어가 실제 서비스 가능한 앱으로 완성된 것입니다.
