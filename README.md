...
### 2단계 — 연세대학교 사회복지대학원 HEART Lab에서 연락

봉사단 결과보고서를 접한 연세대학교 사회복지대학원 HEART Lab에서 연락이 와, AI·공학 기술개발자 포지션으로 유급 연구팀에 합류했습니다.

### 3단계 — Hi-Buddy 개발 (현재)

온쿡에서 확장하여, **발달장애인의 하루 전체를 지원하는 일정 관리 앱**으로 발전시켰습니다.
