...
> [서울청년기획봉사단](https://www.donghaeng.seoul.kr/vproject/esg.do)에서 시작된 아이디어가 실제 서비스 앱이 되기까지 — 봉사활동 → TV 방송 → 대학 연구실 납품 → 스토어 출시

---

## 여기까지 오기까지

### 1단계 — [서울청년기획봉사단](https://www.donghaeng.seoul.kr/vproject/esg.do) 2기 온쉐어 (2025.03 ~ 08)

모든 건 여기서 시작됐습니다.

서울시자원봉사센터 주관 [서울청년기획봉사단](https://www.donghaeng.seoul.kr/vproject/esg.do) 2기에 **온쉐어** 팀 팀장으로 참가했습니다.
팀원들을 이끌면서, 발달장애인을 위한 AI 요리 챗봇 **온쿡(OnCook)** 을 단독 개발하고 실제 복지관 현장에 투입했습니다.
...
봉사단 활동에서 만든 프로토타입 하나가, 이후의 모든 일을 만들어냈습니다.

### 2단계 — 연세대학교에서 연락이 옴 (2025.12)

봉사단 성과를 본 **연세대학교 사회복지대학원 HEART Lab**에서 직접 연락이 왔습니다.
"이런 서비스를 만들고 싶다"는 요청을 받고, AI·공학 기술개발자로 유급 합류하여 Streamlit 기반 웹 프로토타입을 개발해 납품했습니다.

### 3단계 — Hi-Buddy 앱으로 (현재)

납품 후, 이걸 제대로 된 서비스로 만들기로 했습니다.
**Flutter로 iOS/Android 모바일 앱을 직접 개발**하고, 백엔드 서버 구축, 무료 API 전환, 스토어 출시 준비까지 전부 혼자 수행했습니다.

서울청년기획봉사단에서 시작해서, 여기까지 왔습니다.
